...
class Pic1Post extends StatefulWidget {
  final String img_url;
  final String name;

  Pic1Post(this.img_url, this.name);

  @override
  State<Pic1Post> createState() => _Pic1PostState();
}

class _Pic1PostState extends State<Pic1Post> {
  int likes1 = 9999;
  int likes2 = 1478;
  int likes3 = 3258;
